<%@ page language="java" import="java.util.*,com.util.*,java.text.SimpleDateFormat"
...
<BODY text=#000000 bgColor=#ffffff leftMargin=0 topMargin=0>
     ...
     <TABLE class=dragTable cellSpacing=0 cellPadding=0 width="100%" border=0>
      ...
      <td  align="center">点击率</td> 
                    ...
                    String sql2=null; 
                    String fenlei1=request.getParameter("fenlei");
                    String title1=request.getParameter("title");
                    sql2="select * from fz_news where fenlei='"+fenlei+"' and gjz like '%"+title+"%' order by id desc";
