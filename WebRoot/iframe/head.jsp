...
<SCRIPT language=JavaScript src="<%=basePath %>images/css.css"></SCRIPT>
<SCRIPT language=JavaScript src="<%=basePath %>images/default.css"></SCRIPT>
<SCRIPT language=JavaScript src="<%=basePath %>images/MSClass.js"></SCRIPT>
