...
--
-- Dumping data for table `lj`
--

LOCK TABLES `lj` WRITE;
/*!40000 ALTER TABLE `lj` DISABLE KEYS */;
INSERT INTO `lj` VALUES (3,'百度','www.baidu.com'),(4,'广东科技学院','www.gdst.cc');
/*!40000 ALTER TABLE `lj` ENABLE KEYS */;
UNLOCK TABLES;
